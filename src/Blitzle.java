public class Blitzle extends pokemon implements IElectrico{

    public Blitzle(int nroPokeDex, String nombre, double peso, String sexo, int temporada) {
        super(nroPokeDex, nombre, peso, sexo, temporada);
    }

    @Override
    public void placaje() {
        System.out.println("Ataque placaje de Blitzle");
    }
